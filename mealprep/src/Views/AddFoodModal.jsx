      ...
      return(
        ...
        >
          <div className="addFoodModal">
            ...
            <div className="addFoodModalCentered">
              <label className="label" for="daysLeftLabel">Days until Expiration:</label>
              <input className="input" type="number" id="daysLeft" name="daysLeft"
                min="1" defaultValue="1" />
            <Link to="/inventory" onClick={ () => this.props.addToInventory({daysLeft: (document.getElementById("daysLeft") != null) ? document.getElementById("daysLeft").value : "" , ...this.props.nutrients})}>
